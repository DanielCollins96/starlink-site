  ...
  return (
    <div className="flex flex-col bg-gray-500">
      ...
      >
        ...
        >
          <div className="absolute grid max-w-4xl w-11/12 mt-6 text-white text-center left-1/2	top-45 transform -translate-y-2/4 -translate-x-2/4">
            <h2 className="mb-8 text-4xl font-medium lg:mt-12 lg:mb-32 md:text-5xl">Order Starlink</h2>
            <p className="text-xs font-light mb-2 px-4 sm:mb-8 sm:px-12 md:text-base">Starlink is available to a limited number of users per coverage area at this time. Orders will be fulfilled on a first-come, first-served basis.</p>
            <form action="" className="max-w-2xl m-auto w-11/12">
              <div className="relative">
                ...
                <input type="text" id="service-input" className="w-full pt-8 pb-2 pl-4 my-2 bg-mainInputBg bg-opacity-90 outline-none border border-transparent focus:border-white transition duration-300"/>
              </div>
              ...
              <button className="w-full bg-black bg-opacity-50 cursor-not-allowed text-gray-600 border-2  border-gray-600 h-14 md:w-64" type="submit">Order Now</button>
            </form>
          </div>
        </motion.div>
          <div className="absolute w-full text-center bottom-7">
            <p><span className="text-xs font-light mx-2 text-888">By clicking ORDER NOW, you agree to our <Link href="https://www.starlink.com/legal/privacy-policy"><a className="text-white">Privacy Policy</a></Link>.</span></p>
          </div>
      </ImageHero>
      <ImageHero 
        bgPosition='bg-left' 
